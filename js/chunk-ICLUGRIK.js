...
`;var h=class extends n{};h.styles=[$];h=e([m("md-list")],h);var i=class extends a{constructor(){super(...arguments),this.disabled=!1,this.type="text",this.isListItem=!0,this.href="",this.target=""}get isDisabled(){return this.disabled&&this.type!=="link"}willUpdate(t){this.href&&(this.type="link"),super.willUpdate(t)}render(){return this.renderListItem(r`
    ...
    `)}renderListItem(t){let C=this.type==="link",l;switch(this.type){case"link":l=p`a`;break;case"button":l=p`button`;break;default:case"text":l=p`li`;break}let L=this.type!=="text",k=C&&this.target?this.target:s;return b`
      <${l}
        id="item"

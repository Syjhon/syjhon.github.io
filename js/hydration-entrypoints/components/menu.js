import"../../chunk-PKVP2IAO.js";import"../../chunk-KEVGMDHC.js";import{a as P,b as H}from"../../chunk-KLUGGUFV.js";import{b as K,c as v,d as l,e as E,f as L,g as C,l as T}from"../../chunk-BJHRPMJZ.js";import"../../chunk-VXTFZZ7O.js";import"../../chunk-I2I2ZCJZ.js";import{a as O,c as M,e as h,f as D}from"../../chunk-CXCOGLII.js";import"../../chunk-75PIWSVV.js";import"../../chunk-D5TRXHQI.js";import"../../chunk-ZTSP2PIJ.js";import{a as y,b as A}from"../../chunk-PG6OKG6X.js";import{c as $}from"../../chunk-FCVI7UZU.js";import{c as t,e as f,f as r,i as S,l as p,m as I,n as R,o as d,p as k}from"../../chunk-TXMQCKG7.js";import{a as m,d as u}from"../../chunk-F2UFI3JK.js";import"../../chunk-32HEDUCQ.js";var _=$(d),i=class extends _{constructor(){super(...arguments),this.disabled=!1,this.type="menuitem",this.href="",this.target="",this.keepOpen=!1,this.selected=!1,this.menuItemController=new P(this,{getHeadlineElements:()=>this.headlineElements,getSupportingTextElements:()=>this.supportingTextElements,getDefaultElements:()=>this.defaultElements,getInteractiveElement:()=>this.listItemRoot})}get typeaheadText(){return this.menuItemController.typeaheadText}set typeaheadText(e){this.menuItemController.setTypeaheadText(e)}render(){return this.renderListItem(m`
      <md-item>
        <div slot="container">
    ...
    `)}renderListItem(e){let s=this.type==="link",o;switch(this.menuItemController.tagName){case"a":o=y`a`;break;case"button":o=y`button`;break;default:case"li":o=y`li`;break}let a=s&&this.target?this.target:u;return A`
      <${o}
        id="item"
    ...
    `}firstUpdated(){this.onSlotchange()}async show(){let e=this.menu;if(!e||e.open)return;e.addEventListener("closed",()=>{this.item.ariaExpanded="false",this.dispatchEvent(v()),this.dispatchEvent(h()),e.ariaHidden="true"},{once:!0}),e.positioning==="document"&&(e.positioning="absolute"),e.quick=!0,e.hasOverflow=!0,e.anchorCorner=this.anchorCorner,e.menuCorner=this.menuCorner,e.anchorElement=this.item,e.defaultFocus="first-item",e.removeAttribute("aria-hidden"),e.skipRestoreFocus=!1;let s=e.open;if(e.show(),this.item.ariaExpanded="true",this.item.ariaHasPopup="menu",e.id&&this.item.setAttribute("aria-controls",e.id),this.dispatchEvent(h()),this.dispatchEvent(K()),this.item.selected=!0,!s){let o=c=>{},a=new Promise(c=>{o=c});e.addEventListener("opened",o,{once:!0}),await a}}async close(){let e=this.menu;if(!e||!e.open)return;this.dispatchEvent(v()),e.quick=!0,e.close(),this.dispatchEvent(h());let s=a=>{},o=new Promise(a=>{s=a});e.addEventListener("closed",s,{once:!0}),await o}onSlotchange(){if(!this.item)return;this.item.ariaExpanded="false",this.item.ariaHasPopup="menu",this.menu?.id&&this.item.setAttribute("aria-controls",this.menu.id),this.item.keepOpen=!0;let e=this.menu;e&&(e.isSubmenu=!0,e.ariaHidden="true")}onClick(){this.show()}async onKeydown(e){let s=this.isSubmenuOpenKey(e.code);if(e.defaultPrevented)return;let o=s&&(l.LEFT===e.code||l.RIGHT===e.code);if((e.code===E.SPACE||o)&&(e.preventDefault(),o&&e.stopPropagation()),!s)return;let a=this.menu;if(!a)return;let c=a.items,b=M(c);if(b){await this.show(),b.tabIndex=0,b.focus();return}}onCloseSubmenu(e){let{itemPath:s,reason:o}=e.detail;if(s.push(this.item),this.dispatchEvent(v()),o.kind===L.KEYDOWN&&o.key===C.ESCAPE){e.stopPropagation(),this.item.dispatchEvent(D());return}this.dispatchEvent(h())}async onSubMenuKeydown(e){if(e.defaultPrevented)return;let{close:s,keyCode:o}=this.isSubmenuCloseKey(e.code);s&&(e.preventDefault(),(o===l.LEFT||o===l.RIGHT)&&e.stopPropagation(),await this.close(),O(this.menu.items),this.item?.focus(),this.item.tabIndex=0,this.item.focus())}isSubmenuOpenKey(e){let o=getComputedStyle(this).direction==="rtl"?l.LEFT:l.RIGHT;switch(e){case o:case E.SPACE:case E.ENTER:return!0;default:return!1}}isSubmenuCloseKey(e){let o=getComputedStyle(this).direction==="rtl"?l.RIGHT:l.LEFT;switch(e){case o:case C.ESCAPE:return{close:!0,keyCode:e};default:return{close:!1}}}};t([r({attribute:"anchor-corner"})],n.prototype,"anchorCorner",void 0);t([r({attribute:"menu-corner"})],n.prototype,"menuCorner",void 0);t([r({type:Number,attribute:"hover-open-delay"})],n.prototype,"hoverOpenDelay",void 0);t([r({type:Number,attribute:"hover-close-delay"})],n.prototype,"hoverCloseDelay",void 0);t([r({type:Boolean,reflect:!0,attribute:"md-sub-menu"})],n.prototype,"isSubMenu",void 0);t([p({slot:"item",flatten:!0})],n.prototype,"items",void 0);t([p({slot:"menu",flatten:!0})],n.prototype,"menus",void 0);var F=R`:host{position:relative;display:flex;flex-direction:column}

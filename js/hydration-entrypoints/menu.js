...
`;function O(l,e,t){return l?e():t?.()}var ue=j(U(b)),o=class extends ue{get nameStart(){return this.getAttribute("name-start")??this.name}set nameStart(e){this.setAttribute("name-start",e)}get nameEnd(){return this.getAttribute("name-end")??this.nameStart}set nameEnd(e){this.setAttribute("name-end",e)}get renderAriaLabelStart(){let{ariaLabel:e}=this;return this.ariaLabelStart||e&&`${e} start`||this.valueLabelStart||String(this.valueStart)}get renderAriaValueTextStart(){return this.ariaValueTextStart||this.valueLabelStart||String(this.valueStart)}get renderAriaLabelEnd(){let{ariaLabel:e}=this;return this.range?this.ariaLabelEnd||e&&`${e} end`||this.valueLabelEnd||String(this.valueEnd):e||this.valueLabel||String(this.value)}get renderAriaValueTextEnd(){if(this.range)return this.ariaValueTextEnd||this.valueLabelEnd||String(this.valueEnd);let{ariaValueText:e}=this;return e||this.valueLabel||String(this.value)}constructor(){super(),this.min=0,this.max=100,this.valueLabel="",this.valueLabelStart="",this.valueLabelEnd="",this.ariaLabelStart="",this.ariaValueTextStart="",this.ariaLabelEnd="",this.ariaValueTextEnd="",this.step=1,this.ticks=!1,this.labeled=!1,this.range=!1,this.handleStartHover=!1,this.handleEndHover=!1,this.startOnTop=!1,this.handlesOverlapping=!1,this.ripplePointerId=1,this.isRedispatchingEvent=!1,!1||this.addEventListener("click",e=>{!G(e)||!this.inputEnd||(this.focus(),q(this.inputEnd))})}focus(){this.inputEnd?.focus()}willUpdate(e){this.renderValueStart=e.has("valueStart")?this.valueStart:this.inputStart?.valueAsNumber;let t=e.has("valueEnd")&&this.range||e.has("value");this.renderValueEnd=t?this.range?this.valueEnd:this.value:this.inputEnd?.valueAsNumber,e.get("handleStartHover")!==void 0?this.toggleRippleHover(this.rippleStart,this.handleStartHover):e.get("handleEndHover")!==void 0&&this.toggleRippleHover(this.rippleEnd,this.handleEndHover)}updated(e){if(this.range&&(this.renderValueStart=this.inputStart.valueAsNumber),this.renderValueEnd=this.inputEnd.valueAsNumber,this.range){let t=(this.max-this.min)/3;if(this.valueStart===void 0){this.inputStart.valueAsNumber=this.min+t;let r=this.inputStart.valueAsNumber;this.valueStart=this.renderValueStart=r}if(this.valueEnd===void 0){this.inputEnd.valueAsNumber=this.min+2*t;let r=this.inputEnd.valueAsNumber;this.valueEnd=this.renderValueEnd=r}}else this.value??(this.value=this.renderValueEnd);if(e.has("range")||e.has("renderValueStart")||e.has("renderValueEnd")||this.isUpdatePending){let t=this.handleStart?.querySelector(".handleNub"),r=this.handleEnd?.querySelector(".handleNub");this.handlesOverlapping=he(t,r)}this.performUpdate()}render(){let e=this.step===0?1:this.step,t=Math.max(this.max-this.min,e),r=this.range?((this.renderValueStart??this.min)-this.min)/t:0,n=((this.renderValueEnd??this.min)-this.min)/t,m={"--_start-fraction":String(r),"--_end-fraction":String(n),"--_tick-count":String(t/e)},d={ranged:this.range},E=this.valueLabelStart||String(this.renderValueStart),B=(this.range?this.valueLabelEnd:this.valueLabel)||String(this.renderValueEnd),se={start:!0,value:this.renderValueStart,ariaLabel:this.renderAriaLabelStart,ariaValueText:this.renderAriaValueTextStart,ariaMin:this.min,ariaMax:this.valueEnd??this.max},ie={start:!1,value:this.renderValueEnd,ariaLabel:this.renderAriaLabelEnd,ariaValueText:this.renderAriaValueTextEnd,ariaMin:this.range?this.valueStart??this.min:this.min,ariaMax:this.max},le={start:!0,hover:this.handleStartHover,label:E},de={start:!1,hover:this.handleEndHover,label:B},ce={hover:this.handleStartHover||this.handleEndHover};return i` <div
      class="container ${k(d)}"
      style=${A(m)}>
    ...
    `}renderLabel(e){return i`<div class="label" aria-hidden="true">
    ...
    </div>`}renderHandle({start:e,hover:t,label:r}){let n=!this.disabled&&e===this.startOnTop,m=!this.disabled&&this.handlesOverlapping,d=e?"start":"end";return i`<div
      ...
      ${O(this.labeled,()=>this.renderLabel(r))}
    </div>`}renderInput({start:e,value:t,ariaLabel:r,ariaValueText:n,ariaMin:m,ariaMax:d}){let E=e?"start":"end";return i`<input
      type="range"
...
`;var I=class extends o{};I.styles=[re,ee];I=a([g("md-slider")],I);var ae=[0,360],ne=[0,150],oe=[0,100],f=class extends b{constructor(){super(...arguments);this.label="";this.value=0;this.color="";this.type="hue"}render(){let t=ae;return this.type==="chroma"?t=ne:this.type==="tone"&&(t=oe),i`<section>
    ...
    </section>`}onInput(t){let r=t.target;this.value=r.value,this.dispatchEvent(new Event("input"))}buildGradient(){let r="linear-gradient(to right";if(this.type==="hue")for(let n=0;n<100;n++){let m=ae[1]/100*n,d=S(m,100,50);r+=`, ${d} ${n}%`}else if(this.type==="chroma"){let m=L(this.color||"#000").hue;for(let d=0;d<100;d++){let E=ne[1]/100*d,B=S(m,E,50);r+=`, ${B} ${d}%`}}else if(this.type==="tone")for(let n=0;n<100;n++){let m=oe[1]/100*n,d=S(0,0,m);r+=`, ${d} ${n}%`}return r+=")",r}};f.styles=c`
    section {
      display: flex;
  ...
  `,u([s({type:String})],f.prototype,"label",2),u([s({type:Number})],f.prototype,"value",2),u([s({type:String})],f.prototype,"color",2),u([s({type:String})],f.prototype,"type",2),f=u([g("hct-slider")],f);var C=class extends Event{constructor(t){super("change-color",{bubbles:!0,composed:!0});this.color=t}},H=class extends Event{constructor(t){super("change-mode",{bubbles:!0,composed:!0});this.mode=t}};var p=class extends b{constructor(){super(...arguments);this.selectedColorMode=null;this.hexColor="";this.hue=0;this.chroma=0;this.tone=0}render(){return i`
    ...
    </md-outlined-segmented-button>`}onSliderInput(){for(let t of this.sliders)this[t.type]=t.value;this.hexColor=S(this.hue,this.chroma,this.tone),this.dispatchEvent(new C(this.hexColor))}updateHctFromHex(t){let r=L(t);this.hue=r.hue,this.chroma=r.chroma,this.tone=r.tone}onHexPickerInput(){this.hexColor=this.inputEl.value,this.updateHctFromHex(this.hexColor),this.dispatchEvent(new C(this.hexColor))}async firstUpdated(){this.selectedColorMode||(this.selectedColorMode=K()),this.hexColor||(this.hexColor=W()),this.updateHctFromHex(this.hexColor)}onColorModeSelection(t){let{button:r}=t.detail,n=r.dataset.value;this.selectedColorMode=n,this.dispatchEvent(new H(n))}};p.shadowRootOptions={...b.shadowRootOptions,delegatesFocus:!0},p.styles=c`
    :host {
